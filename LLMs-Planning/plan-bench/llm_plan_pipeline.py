...
if __name__=="__main__":
    ...
    # elif task == "t1_react" or task == "t1_rag_react":
    #     prompt_generator.task_1_plan_generation_with_react(specified_instances, random_example)
    # elif task == 't2':
  ...
  #  ========================= Response Generation =========================
    ...
    task_dict = {
        ...
        't1_react': 'task_1_plan_generation_react',
        't1_rag_react': 'task_1_plan_generation_rag_react',
    ...
    if task == "t1_react":
        response_generator.get_react_responses(task_name, run_till_completion=run_till_completion)
    elif task == "t1_rag_react":
        response_generator.get_rag_react_responses(task_name, run_till_completion=run_till_completion)
    else:
